...
// 	void init_values();
	...
	double x_dev, y_dev, prefactor_xydev; //, z_dev //gaussian heat source size parameters
// 	double mobMax;
...
//   int FD_steps;
  ...
  //Let's introduce three new variables to try to make location_finder work better
	...
	//bool *nucleationFlags;
  int nucleationCutoff;
	...
	double Kmc; //MC Scaling pre-factor
 	...
 	int nsmooth; //How many MC steps to perform after solidification to smooth things out
